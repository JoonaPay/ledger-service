...
const identity_event_handler_1 = require("./application/handlers/identity-event.handler");
const metrics_module_1 = require("../../shared/metrics/metrics.module");
const kafka_module_1 = require("../../shared/kafka/kafka.module");
...
exports.LedgerModule = LedgerModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            identity_event_handler_1.IdentityEventHandler,
        ],
